...
public class TestCustomerAccountApp {
    public static void main(String[] args) {
        ...
        try {
            custIdNum = Integer.parseInt(custIdInput);
        }
        catch (NumberFormatException ex){
            //keep customer ID at zero if user did not enter an integer for the ID
        }

        CustomerDB custDb = new CustomerDB();
        Customer customer = custDb.getCustomer(custIdNum);
